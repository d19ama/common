...
.dp__theme_light {
  --dp-background-color: var(--color-form-light);
  --dp-text-color: var(--color-form-dark);
  --dp-border-color: none;
  --dp-menu-border-color: none;
  --dp-border-color-hover: none;
  --dp-border-color-focus: none;
  --dp-icon-color: var(--color-form-dark);
  ...
  --dp-primary-color: var(--color-form-dark);

  ::placeholder {
    color: rgba(var(--color-form-light), .75);
  }
